...
//
// Output is a boolean tensor represented as u32 (0 for false, 1 for true)
// since WGSL does not support bool storage arrays.
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    // Output 1u for true (equal), 0u for false (not equal)
    output[idx] = select(0u, 1u, input_a[a_idx] == input_b[b_idx]);
}
