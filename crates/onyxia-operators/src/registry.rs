...
use crate::operators::{
    ...
    MatMulNBitsOp, MatMulOp, RangeOp, ReduceMeanOp, ReduceSumOp, ReshapeOp, RotaryEmbeddingOp,
    ScatterNDOp, ShapeOp, SimplifiedLayerNormOp, SliceOp, SoftmaxOp, TransposeOp, TriluOp,
    UnsqueezeOp, WhereOp,
};
...
/// - 4 Microsoft contrib operators (SimplifiedLayerNormalization, RotaryEmbedding, GroupQueryAttention, MatMulNBits)
///
