//! MulOperator implementation for elementwise multiplication.
...
/// Operator for elementwise multiplication (ONNX Mul operator).
///
...
mod tests {
    ...
    fn test_mul_kernel_plan() {
        ...
        let steps = MulOperator.plan(&mut ctx).expect("Planning should succeed");
