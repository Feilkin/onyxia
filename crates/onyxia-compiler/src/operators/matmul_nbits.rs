//! MatMulNBitsOperator implementation for N-bit quantized matrix multiplication.
//!
...
/// Operator for N-bit quantized matrix multiplication (ONNX MatMulNBits operator).
///
...
mod tests {
    ...
    fn test_matmul_nbits_infer_output_shapes() {
        ...
        let operator = MatMulNBitsOperator;
