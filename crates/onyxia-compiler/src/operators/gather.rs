//! GatherOperator implementation for embedding lookup and tensor indexing.
...
/// Operator for Gather operation (ONNX Gather operator).
///
...
mod tests {
    ...
    fn test_gather_kernel_output_shape_inference() {
        ...
        let output_shapes = GatherOperator
