//! ReshapeOperator implementation for buffer-copy reshape operations.
...
/// Operator for Reshape operator (buffer copy).
///
...
pub struct ReshapeOperator;

impl OpOperator for ReshapeOperator {
    fn name(&self) -> &str {
        "Reshape"
    }
