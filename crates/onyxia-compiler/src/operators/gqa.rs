//! GroupQueryAttentionOperator implementation for fused multi-head attention with KV cache.
...
/// Operator for GroupQueryAttention (Microsoft contrib op).
///
...
mod tests {
    ...
    fn test_gqa_kernel_shape_inference() {
        let operator = GroupQueryAttentionOperator;
    ...
    fn test_gqa_kernel_plan_structure() {
        ...
        let steps = GroupQueryAttentionOperator
            .plan(&mut ctx)
