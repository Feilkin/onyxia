//! MatMulF32Operator implementation for f32 matrix multiplication.
...
/// Operator for f32 matrix multiplication (ONNX MatMul operator).
///
...
pub struct MatMulF32Operator;

impl OpOperator for MatMulF32Operator {
    fn name(&self) -> &str {
        "MatMulF32"
    }
...
mod tests {
    ...
    fn test_matmul_kernel_invalid_shapes() {
        ...
        let result = MatMulF32Operator.plan(&mut ctx);
