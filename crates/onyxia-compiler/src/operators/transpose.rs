//! TransposeOperator implementation for tensor dimension permutation.
...
/// Operator for transpose operation (ONNX Transpose operator).
///
...
impl OpOperator for TransposeOperator {
    fn name(&self) -> &str {
        "Transpose"
    }
...
mod tests {
    ...
    fn test_transpose_kernel_shape_inference_2d() {
        let operator = TransposeOperator;
