//! ConstantOfShapeOperator implementation for ONNX ConstantOfShape nodes.
...
/// Operator for ONNX ConstantOfShape operator.
///
...
mod tests {
    ...
    fn test_constantofshape_kernel_shape_inference() {
        ...
        let operator = ConstantOfShapeOperator;
        let graph = Graph::new();
