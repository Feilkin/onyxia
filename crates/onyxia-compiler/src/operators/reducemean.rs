//! ReduceMeanOperator implementation for mean reduction along axes.
...
/// Operator for mean-reducing a tensor along specified axes (ONNX ReduceMean operator).
///
...
mod tests {
    ...
    fn test_reducemean_kernel_keepdims() {
        ...
        let output_shapes = ReduceMeanOperator
            .infer_output_shapes(&{
