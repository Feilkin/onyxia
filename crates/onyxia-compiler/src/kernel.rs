...
impl KernelRegistry {
    ...
    ///
    /// Registers all implemented kernels (Add, Mul, Gelu, RMSNorm, MatMulF32, Cast)
    pub fn with_defaults() -> Self {
        ...
        registry.register("Div", Box::new(crate::kernels::DivKernel));
        ...
        registry.register("Max", Box::new(crate::kernels::MaxKernel));
        ...
        registry.register("ScatterND", Box::new(crate::kernels::ScatterNDKernel));
