//! RangeKernel implementation for ONNX Range nodes.
...
/// Kernel for ONNX Range operator.
///
...
mod tests {
    ...
    fn test_try_fold_integer_range() {
        ...
        let folded = kernel.try_fold(&ctx).expect("Folding should succeed");
