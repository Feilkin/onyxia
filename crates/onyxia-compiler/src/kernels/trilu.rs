//! TriluKernel implementation for triangular matrix extraction.
...
/// Kernel for Trilu (ONNX Trilu operator).
///
...
mod tests {
    ...
    fn test_trilu_kernel_name() {
        let kernel = TriluKernel;
        assert_eq!(kernel.name(), "Trilu");
    }
