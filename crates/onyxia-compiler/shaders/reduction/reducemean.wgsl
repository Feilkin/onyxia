// ReduceMean: Mean-reduce a tensor along specified axes
//
// For simplicity, this implementation handles single-axis reduction.
// Each workgroup processes one output element - computing the mean of all values along the reduction axis.
...
fn main(
    ...
    //   Each output element computes mean of 8 values from input
    ...
    if (local_thread_idx == 0u) {
        ...
        output[workgroup_id.x] = total / f32(params.reduce_size);
    }
}
