//! ScatterNDKernel implementation for scattered tensor updates.
...
/// Kernel for ScatterND operation (ONNX ScatterND operator).
///
...
impl OpKernel for ScatterNDKernel {
    fn name(&self) -> &str {
        "ScatterND"
    }
...
mod tests {
    ...
    fn test_scatternd_kernel_infer_output_shapes() {
        ...
        let output_shapes = ScatterNDKernel
