//! DivKernel implementation for elementwise division.
...
/// Kernel for elementwise division (ONNX Div operator).
///
...
mod tests {
    ...
    fn test_div_kernel_plan() {
        ...
        let steps = DivKernel.plan(&mut ctx).expect("Planning should succeed");
